<head>
    ...
    <script src="/board_files/scripts.bundle.js"></script>
    ...
    <!--begin::Google tag-->
    <script type="text/javascript" async="" src="./board_files/analytics.js.download"></script>
    <script type="text/javascript" async="" src="./board_files/js"></script>
    <script async="" src="./board_files/js(1)"></script>
    <script>
